...
type BoardColumnStatusModel struct {
	...
	BoardColumnID uuid.UUID `gorm:"type:char(36) references board_column;not null;uniqueIndex:board_column_id_status_id;"`
	StatusID      uuid.UUID `gorm:"type:char(36) references status;not null;uniqueIndex:board_column_id_status_id;"`
